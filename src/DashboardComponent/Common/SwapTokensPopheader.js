...
const SwapTokensPop = ({ handleClose, OnSubmit, TokenData, open }) => {
                                ...
                                <div className='swap_tokens_list'>
                                    ...
                                    <ul>
                                      ...
                                      {TokenData[2].text}
                                        ...
                                        {TokenData[0].text}
                                        <br/> <br/>
                                      <div className='hero_btn' onClick={(e) => OnSubmit(e)} >
        <a href="#0">{TokenData[1].text}  </a>
        </div>
                                          {/* <b>{TokenData[0].text}</b> */}
                                        {/* <br/><br/> */} <br/>
                                        ...
                                        {/* {TokenData.map((Data) => {
                                            return (
                                                <center> 
                                                    // {/* <li onClick={(e) => OnSubmit(e)} id={Data.text} key={Data.text} > */}
                                                    {/*  */}
                                                        {/* <img src={Data.imglogo} alt={Data.id} /> */}
                                                        {/* <p> {Data.text}</p> */}
                                                    {/* <span>{Data.text}</span> */}
                                                {/* </li> */}
                                                {/* </center> */}
