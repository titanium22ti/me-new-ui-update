                ...
                <div className='Withdraw_main_row'>
                    <div className='Withdraw_main_row_row'>
                        ...
                        <div className='deposits_block deposits_block_line'>
                            ...
                            <h5 className='mer_text_h5 text-wrap Market_text_p'>{JokerBlance1 ? parseFloat(Math.abs(JokerBlance1 / 1e9)).toFixed(3) : "0.0"}</h5>
                        </div>
                        <span className='Market_Cap_center_span'></span>
                        <div className='deposits_block'>
                            <p className='Market_text_p'>My Wallet Balance</p>
                            <h5 className='mer_text_h5 text-wrap Market_text_p'>{JokerBlance ? parseFloat(Math.abs(JokerBlance / 1e9)).toFixed(3) : "0.0"}</h5>
                        </div>
