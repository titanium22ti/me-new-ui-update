...
import ethLogo from '../../assets/images/HomePage/usd-coin-usdc-logo.png';
...
import { BLACKTokenABI, BLACKTokenAddress, FaucetABI, FaucetAddress, USDCAddress } from '../../abi/abi';
                ...
                <div className='Withdraw_main_row'>
                    <div className='Withdraw_main_row_row'>
                        ...
                        <div className='deposits_block'>
                            ...
                            {gbalances.usdc?parseFloat(Math.abs(gbalances.usdc)).toFixed(3):"0.0"}
                    ...
                    <div className='trade_btn_row'>
                       ...
                       {/* {chainId === 84532 ?(<> */}
                        <div><ButtonLoad loading={loader} onClick={() => window.open(`https://faucet.circle.com/`, '_blank')}>Get USDC</ButtonLoad></div>
                       {/* </>):(<>
