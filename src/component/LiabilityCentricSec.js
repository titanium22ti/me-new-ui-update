            ...
            <Container>
                <div className='liability_centric_row'>
                    <div className='liability_text'>
                        <WebHeading heading_text="Empowering Stability with Burn Vault -" heading_text_color="Cash Out " heading_text2="with Confidence, No " heading_text_color1 ="Market Impact! " />
                    </div>
